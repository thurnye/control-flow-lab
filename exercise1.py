...
# letter = str(input('Please enter a letter from the alphabet (a-z or A-Z)').lower())



# if letter in vowel:
#     text = f"The letter {letter} is a vowel"
# else :
#     text = f"The letter {letter} is a consonant"
# print(text)
...
#      - A triangle with sides of <a>, <b> & <c> is a <type of triangle> triangle1

# a = int(input('Enter 1 side of a triangle'))
# b = int(input('Enter 2 side of the triangle'))
# c = int(input('Enter 3 side of the triangle'))
